...
const Inicio = () => {
    ...
    return (
        <div>
            <Title/>
            <HeroVideo image="HeroImage.jpg" heading="Paneles solares para hogares, comercios e industria." message="1 Año de poliza de mantenimiento gratis" size="md:h-[789px] h-[600px]"/>
