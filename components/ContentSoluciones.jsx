...
const ContentSoluciones = () => {
    return (
        <div className="2xl:mx-[425px] xl:mx-[215px] lg:mx-[75px] lg:mt-[58px] mx-8">
            {imagesWD && imagesWD.map((item) =>
                ...
                <div className={item.id %2 === 0 ? "flex md:flex-row flex-col md:space-x-20 mt-[112px] md:text-left text-center " : "flex flex-col md:flex-row-reverse mt-[112px] md:text-left text-center"} key={item.id}>
                        ...
                        <div className="md:mr-20 space-y-8 mt-10 md:mt-0">
                            ...
                            <p className="font-base 2xl:text-[25px] text-[17px] leading-[27px] text-gray-700">{item.body}</p>
                            <p className="font-base 2xl:text-[25px] text-[17px] leading-[27px] text-gray-700 whitespace-pre-line text-left">{item.details}</p>
                        </div>
                </div>
            )}
        </div>
