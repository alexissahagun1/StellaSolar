...
const Beneficios = ({file, headingColor, isUppercase, isScaled, hasMargin, isHidden, marginQuantity}) => {
    return (
       <div className={`grid md:grid-cols-2 grid-cols-1 justify-items-center md:mt-10 ${marginQuantity} lg:mx-[50px] mx-[10px] align-middle ${isHidden ? "hidden md:grid" : "md:hidden"}`}>
               {file && file.map((item) =>
