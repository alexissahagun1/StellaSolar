...
const Certificaciones = () => {
    ...
    return (
        ...
        <div>
            <div className="relative md:h-[1500px] h-[1400px] md:w-screen mt-20">
                ...
                <div className="relative flex flex-col items-center mx-8 md:mx-0">
                    ...
                    <div className="flex flex-row space-x-10 mt-[60px] items-end">
                        <h6 className="w-56 font-semibold text-gray-700 leading-[22px] uppercase text-[20px]">Certificación en los estándares <span className="text-green-400">ECO586.01</span> y <span className="text-green-400">EC1181</span></h6>
                        <img src="icons/Certificaciones/Icon1.png" alt=""/>
                    </div>

                    <div className="flex md:flex-row flex-col justify-center mt-[75px] space-y-10 md:space-y-0 mx-[220px]">
                        ...
                        <div className="flex flex-col items-center space-y-5 mx-16">
                            ...
                            <div className="space-y-1 w-[200px] md:text-left text-center">
                                <h6 className="stella-orange font-semibold text-[20px] leading-[22px]">NOM-0029-STPS</h6>
                        ...
                        <div className="flex flex-col items-center space-y-5 mx-16">
                            ...
                            <div className="space-y-1 w-[200px] md:text-left text-center">
                                <h6 className="stella-orange font-semibold text-[20px] leading-[22px]">NOM-002-STPS</h6>
                        ...
                        <div className="flex flex-col items-center space-y-5 mx-16">
                            ...
                            <div className="space-y-1 w-[200px] md:text-left text-center">
                                <h6 className="stella-orange font-semibold text-[20px] leading-[22px]">NOM-006-STPS</h6>
                        ...
                        <div className="flex flex-col items-center space-y-5 mx-16">
                            ...
                            <div className="space-y-1 w-[200px] md:text-left text-center">
                                <h6 className="stella-orange font-semibold text-[20px] leading-[22px]">NOM-009-STPS</h6>
